    ...
    <div className="flex items-center gap-3">
      <button
        ...
        className={`flex items-center gap-2 px-4 py-2 rounded-lg font-[700] text-[13px] transition-all border ${
          isSaved
            ? "bg-[rgba(200,217,230,0.4)] text-article border-line"
            : "bg-surface text-article border-line hover:border-line hover:text-article"
      ...
      <button
        ...
        className={`flex items-center gap-2 px-4 py-2 rounded-lg font-[700] text-[13px] transition-all border ${
          isDone
            ...
            : "bg-surface text-article border-line hover:border-[#10b981] hover:text-[#10b981]"
        }`}
      >
