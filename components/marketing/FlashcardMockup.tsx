  ...
  <div className="bg-white rounded-3xl border border-gray-200 shadow-[0_8px_32px_rgba(0,0,0,0.04)] w-full text-center relative overflow-hidden flex flex-col h-[480px]">
    ...
    <div className="relative flex flex-col items-center justify-center flex-1 p-6 overflow-hidden">
      ...
      <div className="relative w-full max-w-[460px] h-[220px] flex items-center justify-center shrink-0 mb-8 mx-auto">
         {/* Ghost 2 */}
         <div className="absolute w-full max-w-[420px] h-[200px] rounded-xl opacity-35 z-[8] bg-reward-soft translate-y-5 scale-95" />
         {/* Ghost 1 */}
         <div className="absolute w-full max-w-[420px] h-[200px] rounded-xl opacity-60 z-[9] bg-reward-soft translate-y-2.5 scale-[0.97]" />

         {/* Active Card */}
         <motion.div 
           whileHover={{ y: -4, boxShadow: "0px 10px 20px rgba(0,0,0,0.15)" }} 
           transition={{ duration: 0.2, ease: "easeInOut" }}
           className="absolute w-full max-w-[420px] min-h-[200px] rounded-xl p-6 shadow-[0_8px_32px_rgba(0,0,0,0.15)] flex flex-col z-[10] cursor-grab text-left bg-reward-soft"
         >
