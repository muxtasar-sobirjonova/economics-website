  ...
  return (
    <div className="min-h-screen bg-bg bg-sky flex flex-col">
      ...
      <main className="flex-1 max-w-[600px] w-full mx-auto p-6 md:p-10 flex flex-col gap-6">
        {/* Profile Card */}
        <div className="bg-surface rounded-3xl p-8 border border-line shadow-sm flex flex-col items-center text-center relative overflow-hidden">
          <div className="absolute top-0 left-0 right-0 h-24 bg-gradient-to-br from-accent-soft to-indigo-500/20"></div>
          
          <div className="w-24 h-24 rounded-full bg-accent text-white font-black text-4xl flex items-center justify-center shadow-lg border-4 border-white relative z-10 mb-4">
            {avatarLetter}
          </div>
          ...
          <div className="w-full flex gap-4 mt-2">
            <div className="flex-1 bg-bg rounded-lg p-4 flex flex-col items-center justify-center border border-line">
              ...
              <div className="text-2xl font-black text-ink">{user.progress?.totalXP || 0} (Global)</div>
        ...
        <div className="bg-surface rounded-3xl p-6 border border-line shadow-sm flex flex-col">
          ...
          <div className="flex items-center justify-between p-4 bg-bg rounded-lg border border-line mb-4">
            ...
            <Link href="/track-selection" className="text-xs font-bold text-accent hover:underline px-2 py-1">
              Change
            </Link>
          </div>
