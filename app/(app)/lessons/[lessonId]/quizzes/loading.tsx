...
export default function Loading() {
  return (
    <div className="min-h-screen font-sans flex flex-col text-ink bg-bg">
      {/* Skeleton Top Bar */}
      <header className="sticky top-0 z-50 bg-surface border-b border-line flex items-center justify-between px-10 py-4">
      ...
      <main className="px-10 pb-16 max-w-[1240px] w-full mx-auto mt-4">
        ...
        <div className="flex items-center mb-10 px-8 py-4 rounded-3xl bg-surface border border-line shadow-sm relative h-[116px]">
        ...
        <div className="flex flex-col md:flex-row gap-6">
          <div className="flex-1 bg-surface p-8 border border-line border-l-4 border-l-gray-300 rounded-2xl h-[180px] animate-pulse"></div>
          <div className="w-full md:w-[340px] bg-surface p-8 border border-line border-l-4 border-l-gray-300 rounded-2xl h-[280px] animate-pulse"></div>
        </div>
