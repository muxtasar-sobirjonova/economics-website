  ...
  return (
    <div className="min-h-screen font-sans flex flex-col text-slate-800 bg-slate-50">
      ...
      <main className="px-10 pb-16 max-w-[1240px] w-full mx-auto mt-4">
        ...
        <div className="flex items-center mb-10 px-8 py-4 rounded-3xl bg-white border border-gray-200 shadow-sm relative h-[116px]">
        ...
        <div className="flex flex-col md:flex-row gap-6">
          <div className="flex-1 bg-white p-8 border border-gray-200 border-l-4 border-l-gray-300 rounded-2xl h-[180px] animate-pulse"></div>
          <div className="w-full md:w-[340px] bg-white p-8 border border-gray-200 border-l-4 border-l-gray-300 rounded-2xl h-[280px] animate-pulse"></div>
        </div>
